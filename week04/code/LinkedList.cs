   ...
   public void Remove(int value)
{
    ...
    while (curr is not null)
    {
        if (curr.Data == value)
        {
            ...
            return; // Stop searching once the match is found and removed
        }
...
{
    // Search through the entire list, replacing every node that matches
    Node? curr = _head;
    while (curr is not null)
    {
        ...
        curr = curr.Next; // Continue to the next node regardless of a match
    }
}
